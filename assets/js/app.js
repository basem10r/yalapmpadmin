+(function ($, window) {
  ...
  $(function () {
    ...
    var createGradientPrimary = defs
  ...
  $(function () {
    var defs = d3.select("defs");
    var createGradientSuccess = defs
      .append("linearGradient")
  ...
  $(function () {
    var defs = d3.select("defs");
    var createGradientWarning = defs
      .append("linearGradient")
